...
tf.app.flags.DEFINE_string('predict', 'Logs/model.ckpt-41500', """ checkpoint file """)
tf.app.flags.DEFINE_string('finetune', 'Logs/model.ckpt-33000', """ finetune checkpoint file """)
...
tf.app.flags.DEFINE_string('test_dir', "train.txt", """ path to CamVid test image """)
tf.app.flags.DEFINE_string('predict_dir', "test.avi", """ path to CamVid image """)
...
def checkArgs():
    if FLAGS.testing != '':
        ...
        print('The model is set to Predict')
