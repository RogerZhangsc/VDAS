...
path = 'C:\\Users\\Sunny\\Desktop\\VDAS\\mask_test_data'
...
while(i<numberOfVideos):
    ...
    output_path_video=output_path+"\\"+videoList[i]+"_new_stitched_comparison.avi"
    ...
    while success: 
        ...
        if(MULTI_STITCH!=0):
            ...
            result_image_1 = stitch_left_based(frame_2,frame_1, M)
            ...
            result_image_2 = stitch_left_based(frame_2,frame_3, M)
            ...
            result_image_1 = stitch_left_based(result_image_1,result_image_2, M)
            result_image_1 = cv2.resize(result_image_1,frame_size,interpolation=cv2.INTER_CUBIC)   
            ...
            result_image_2 = stitch_left_based(frame_2,frame_1, M)
            result_image_2 = cv2.resize(result_image_2,frame_size,interpolation=cv2.INTER_CUBIC)
            ...
            result_image_3 = stitch_left_based(frame_2,frame_3, M)
            ...
            result_image_2 = stitch_left_based(result_image_2,result_image_3, M)
            result_image_2 = cv2.resize(result_image_2,frame_size,interpolation=cv2.INTER_CUBIC)   
            ...
            result_image_3 = stitch_left_based(frame_2,frame_1, M)
            result_image_3 = cv2.resize(result_image_3,frame_size,interpolation=cv2.INTER_CUBIC)
            ...
            result_image_4 = stitch_left_based(frame_2,frame_3, M)
            ...
            result_image_3 = stitch_left_based(result_image_3,result_image_4, M)
            result_image_3 = cv2.resize(result_image_3,frame_size,interpolation=cv2.INTER_CUBIC)   
            ...
            result_image_4 = stitch_left_based(frame_2,frame_1, M)
            result_image_4 = cv2.resize(result_image_4,frame_size,interpolation=cv2.INTER_CUBIC)
            ...
            result_image_5 = stitch_left_based(frame_2,frame_3, M)
            ...
            result_image_4 = stitch_left_based(result_image_4,result_image_5, M)
            result_image_4 = cv2.resize(result_image_4,frame_size,interpolation=cv2.INTER_CUBIC)   
...
#==============================================================================
#             M =  get_sift(frame_2,frame_1)
#             result_image = stitch_left_based(frame_2,frame_1, M)
...
#             result_image = stitch_left_based(result_image,result_image_2, M)
#             result_image = cv2.resize(result_image,frame_size,interpolation=cv2.INTER_CUBIC)    
# 
...
#==============================================================================
#             try: 
#                 result = stitcher.stitch((frame_1,frame_2))
#                 result_image = stitcher.stitch((result[1],frame_3))
#                 videoWriter.write(result_image[1])
#             except Exception as e:
#                 print(e)
#                 cv2.imshow("Frame1",frame_1)
#                 cv2.imwrite(output_path+"\\1.png",frame_1)
#                 cv2.imshow("Frame2",frame_2)
#                 cv2.imwrite(output_path+"\\2.png",frame_2)
#             
#                 cv2.imshow("Frame3",frame_3)
#                 cv2.imwrite(output_path+"\\3.png",frame_3)
#                 break
#                 
#==============================================================================
        if(count%30==0):
